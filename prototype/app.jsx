      ...
      <div className="app">
          ...
          <div className="topbar-right">
            {!revealed ? (
              <span className="pill" style={{ color: "var(--ink-subtle)" }}>
                <span className="dot" style={{ background: "var(--ink-subtle)" }} /> results hidden
              </span>
            ) : picked ? (
        ...
        <main className="stage-body">
          ...
          <div style={{ display: tab === "decision" ? "block" : "none", position: "absolute", inset: 0 }} data-screen-label="02 Decision">
            <Decision dec={dec} setDec={setDec} tweaks={tweaks} revealed={revealed} setRevealed={setRevealed} />
          </div>
        </main>
      </div>
